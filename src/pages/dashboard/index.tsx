...
const Dashboard = () => {
    ...
    const deleteBubble = (id: string) => {
        void (async () => {
            ...
            if (!error) {
                toast.success("Bubble deleted successfully");
                                ...
                                {bubbles.map((bubble, i) => (
                                    <div
                                        ...
                                        onClick={(e) => {
                                            ...
                                            // check if the user clicked on the delete button or something inside of it
                                            if (
                                                deleteButton?.isEqualNode((e.target as Node).parentElement) ||
                                                deleteButton?.isEqualNode((e.target as Node).parentElement!.parentElement) ||
                                                deleteButton?.isEqualNode(e.target as Node)
                                            ) {
                                                return;
                                            }
                                            void router.push(`/bubbles/${bubble.id}`);
                                    ...
                                    >
                                        <div className="flex flex-row justify-between">
                                            ...
                                            <span id={`delete${i}`} className="m-4 group hover:bg-red-700 h-fit transition-colors p-1 rounded-md">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="inline-block h-5 w-5 float-right cursor-pointer"
                                                    viewBox="0 0 20 20"
